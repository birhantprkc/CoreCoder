...
**The nanoGPT of coding agents. A 1.2k-line engine inside 2,485 readable lines of pure Python: understand how a coding agent actually works, then fork your own.**
...
[![engine](https://img.shields.io/badge/engine-1243_LoC-blue)](article/00-index_EN.md)
...
|---|---|---|---|---|
| Lines of code | ~1,243 engine / 2,485 total | hundreds of thousands (closed) | tens of thousands of Python | ~600 (two files) |
...
The engine (loop, model interface, context, tools, sessions) is 1,243 lines once you drop blank lines and comments. Counting the outer CLI, config and packaging too, the whole package is 24 files: 2,485 physical lines, 2,017 net, every one short enough to read in a single sitting. The growth since the original 1,161-line snapshot went into visible features: plan mode, hooks and checkpoints, each documented below.
